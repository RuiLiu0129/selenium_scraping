...
class Profile(ResultsObject):
    ...
    def personal_info(self):
        ...
        top_card = one_or_default(self.soup, '.pv-top-card-v3.artdeco-card.ember-view')
        ...
        personal_info = get_info(top_card, {
            ...
            'name': 'li.inline.t-24.t-black.t-normal.break-words',
            'headline': 'h2.mt1.inline-block.t-18.t-black.t-normal',
            'company': '.pv-top-card-v3--experience-list',
            'school': '.pv-top-card-v3--experience-list-item[2]',
            'location': 'li.t-16.t-black.t-normal.inline-block',
        })

        personal_info['summary'] = text_or_default(self.soup, '.pv-about__summary-text mt4 t-14 ember-view')
